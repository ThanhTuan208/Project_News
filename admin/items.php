        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"><a href="form_add_item.php"> <i class="icon-plus"></i>
                            </a></span>
                        <h5>Items</h5>
                    </div>
                        ...
                        <table class="table table-bordered
                            ...
                            foreach ($search as $key => $value):
                                ...
                                <tbody>
                                    <tr class="">
                                        <td width="250">
                                            <img class="img-fluid h-100" src="../anh/<?php echo $value['image'] ?>"
                                        ...
                                        <td>
                                            <a href="form_update.php?id=<?php echo $value['id'] ?>" class="btn
                                                    btn-success btn-mini">Edit</a>
                                            <a href="delete.php?item_id=<?php echo $value['id'] ?>" class="btn
